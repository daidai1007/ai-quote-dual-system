...
pixel_size(option_page.findChild(QLabel, "scheme2SectionTitle"), 16)
pixel_size(option_page.findChild(QLabel, "scheme2OptionGroupTitle"), 13)
pixel_size(option_page.findChild(QLabel, "scheme2OptionLabel"), 12)
pixel_size(window.product_combo, 13)

cost_page = window.stack.widget(3)
pixel_size(cost_page.findChild(QLabel, "scheme2PageTitle"), 16)
pixel_size(cost_page.findChild(QLabel, "scheme2SidebarTitle"), 13)
pixel_size(cost_page.findChild(QLabel, "scheme2FieldLabel"), 12)
pixel_size(window.scheme2_cost_controls["carbon_price"], 13)
pixel_size(window.summary_table, 12)
...
assert "padding:7px 8px; font-size:12px; font-weight:600;" in window.styleSheet()
